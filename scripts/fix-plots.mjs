...
// Delete plots beyond the first 100
const { error } = await supabase.from('plots').delete().gt('id', 100)
...
console.log(`✅ Fixed! Total plots: ${plots.length}`)
console.log(`🟤 Bronze: ${tiers.bronze} | ⚪ Silver: ${tiers.silver} | 🟡 Gold: ${tiers.gold} | 💎 Diamond: ${tiers.diamond}`)
